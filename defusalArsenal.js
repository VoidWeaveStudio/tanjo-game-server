...
const ARSENAL_BY_ID = new Map(ARSENAL.map((item) => [item.id, item]));
const DEFAULT_MELEE = "rug-beater";
const DEFAULT_PISTOL = "dust-nine";
const GRENADE_LIMIT = 2;
function arsenalFor(side) {
...
module.exports = { DEFUSAL_ECONOMY, ARSENAL, ARSENAL_BY_ID, DEFAULT_MELEE, DEFAULT_PISTOL, GRENADE_LIMIT, arsenalFor, isBuyable, RUG };
